...
interface IProps{
    updateModalCreate:boolean
    setUpdateModalCreate:(value:boolean) => void
    blog: IBlog | null
    setBlog: (value: IBlog | null) => void
}

function UpdateModal(props: IProps) {
  const {updateModalCreate,setUpdateModalCreate, blog, setBlog} = props;
  ...
  const handleCloseModal = () =>{
    ...
    setContent("")
    setBlog(null)
    setUpdateModalCreate(false)
  }
  return (
    <>

      <Modal
        show={updateModalCreate}
